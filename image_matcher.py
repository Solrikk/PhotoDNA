...
class ImageMatcher:
    def __init__(self):
        ...
        try:
            ...
            logging.info("Модель spaCy 'ru_core_news_sm' не найдена. Загружаю...")
    ...
    def preprocess_image(self, img_path):
        try:
            ...
            logging.warning(f"Ошибка при предварительной обработке изображения: {str(e)}")
            return None
    ...
    def compare_images_batch(embedding1, embeddings_list):
        ...
        try:
            ...
            logging.warning(f"Ошибка при пакетном сравнении изображений: {str(e)}")
